...
namespace EawXBuild.Configuration.CLI
{
    public interface IOptions
    {
        ...
        [Option('l', "lua", Default = false, Group = "backend-lua", HelpText = "Run the CI Tool with a lua-based configuration.")]
        public bool BackendLua { get; set; }
        
        [Option('x', "xml", Default = true, Group = "backend-xml", HelpText = "Run the CI Tool with a xml-based configuration. This is the default option.")]
